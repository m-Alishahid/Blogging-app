...
//             />
//             <CardTitle className="text-xl ont-normal mt-4 text-center">{post.title}</CardTitle>
//             <br />
...
//                     className={`w-full px-6 text-white bg-blue-600 rounded hover:bg-blue-500 ${isDarkBackground ? 'bg-black hove:bg-red-500' : 'bg-black hover:bg-red-500'} `}
//                 >
//                     Read More..
